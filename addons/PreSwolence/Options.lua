...
local VISUAL_DEFAULTS = {
    ...
    -- Container
    containerAlpha  = 0.95,
    containerR      = 0.039, containerG = 0.039, containerB = 0.059,
    borderR         = 0.20,  borderG    = 0.15,  borderB    = 0.35,
    containerShowBorder = true,
    -- Prescience bar colours (full)
    presFullR  = 0.655, presFullG  = 0.545, presFullB  = 0.980,
    presMidR   = 0.95,  presMidG   = 0.60,  presMidB   = 0.10,
    presLowR   = 0.90,  presLowG   = 0.15,  presLowB   = 0.15,
    presActiveBorderR   = 0.655, presActiveBorderG   = 0.545, presActiveBorderB   = 0.980,
    presInactiveBorderR = 0.25,  presInactiveBorderG = 0.25,  presInactiveBorderB = 0.30,
    presShowBorder = true,
    -- Ebon Might bar colours
    emFullR    = 0.957, emFullG    = 0.447, emFullB    = 0.714,
    emMidR     = 0.90,  emMidG     = 0.55,  emMidB     = 0.10,
    emLowR     = 0.90,  emLowG     = 0.15,  emLowB     = 0.15,
    emAccentR           = 0.957, emAccentG           = 0.447, emAccentB           = 0.714,
    emActiveBorderR     = 0.957, emActiveBorderG     = 0.447, emActiveBorderB     = 0.714,
    emInactiveBorderR   = 0.25,  emInactiveBorderG   = 0.15,  emInactiveBorderB   = 0.20,
    emShowBorder        = true,
    -- Font
    fontSize    = 11,
    fontOutline = "OUTLINE",
